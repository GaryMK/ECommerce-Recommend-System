 ...
 * FileName:  ALSTrainer.scala
 * Author:  GaryMK
 * Date:  2021/1/3 下午7:45
 * Version:  1.0
 * LastModified:  2021/1/3 下午7:45
 *
 */
...
import com.morningstar.offline.OfflineRecommender.MONGODB_RATING_COLLECTION
...
object ALSTrainer {
  def main(args: Array[String]): Unit = {
    ...
    // 核心实现，输出最优参数
    adjustALSParams(trainingRDD, testRDD)
