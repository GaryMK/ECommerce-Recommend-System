 ...
 * FileName:  ItemCFRecommender.scala
 * Author:  GaryMK
 * Date:  2021/1/6 下午4:44
 * Version:  1.0
 * LastModified:  2021/1/6 下午4:44
 *
 */

package com.morningstar.itemcf
...
object ItemCFRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 创建一张临时表，用于写sql查询
    joinedDF.createOrReplaceTempView("joinded")
